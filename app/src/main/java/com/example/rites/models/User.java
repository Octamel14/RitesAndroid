...
public class User {
    ...
    public User(Integer id_user, String first_name, String last_name, String email, String password, Boolean is_rider, int rider_score, int riders_number, int scored) {
